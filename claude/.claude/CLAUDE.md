...
Full-stack developer building Parts2U — a custom stone parts e-commerce app — as an indie project targeting the App Store and Google Play.

## Projects

**Parts2U** (`~/Source/Active/Parts2U`) — main active project
